...
var PopupLayer = new Class({
	...
	_loadOverlay:function(){                //加载遮罩
	    ...
	    this.overlay.css({position:"absolute","z-index":1,left:0,top:0,zoom:1,display:"none",width:pageWidth,height:$(document).height()}).appendTo($(document.body)).append("<div style='position:absolute;z-index:2;width:100%;height:100%;left:0;top:0;opacity:0.3;filter:Alpha(opacity=30);background:#000'></div><div class='popLayerDiv' style='width:100%;height:100%;position:absolute;z-index:1;left:0;top:0;filter:Alpha(opacity=0);'></div>")
		//this.overlay.css({ position: "absolute"}).appendTo($(document.body));
		//$("body").append("<button>bbbbbbbbbbbbttttttttttttttttnnnnnnnnnnn</button>")
	},
	doresize:function(){
